...
class ArticleHasFavouriteModel {
  public:
    ...
    * @return std::pair<unsigned int, bool> This returns the favourite count and the user's favourited status for the article. The favourite count becomes -1 if an error occured.
    */
    ...
    * @return std::unordered_map<std::string, std::pair<unsigned int, bool>>  This returns the favourite count and the user's favourited status for the article. The favourite count becomes -1 if an error occured.
    */
